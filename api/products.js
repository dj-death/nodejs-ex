...
var Service = {
    list: function(params, callback, sid, req) {
        session.verify(req).then(function(session) {
            ...
            return models.Product.scope('nested').findAndCount(
                helpers.sequelizify(params, models.Product));
    ...
    update: function(params, callback, sid, req) {
        session.verify(req).then(function(session) {
            ...
            return models.Product.scope('nested').findOne({
                where: {
                    id: params.id
                }
            });
    ...
    filters: function(params, callback, sid, req) {
        session.verify(req).then(function() {
            return helpers.fetchFilters(params, models.Product);
