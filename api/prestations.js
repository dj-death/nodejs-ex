...
var Service = {
    list: function(params, callback, sid, req) {
        session.verify(req).then(function(session) {
            ...
            return models.Prestation.scope('nested').findAndCount(
                helpers.sequelizify(params, models.Prestation));
    ...
    insert: function(params, callback, sid, req) {
        session.verify(req).then(function(session) {
            ...
            return models.Prestation.create(params);
        }).then(function(row) {
    ...
    update: function(params, callback, sid, req) {
        session.verify(req).then(function(session) {
            ...
            return models.Prestation.scope('nested').findOne({
                where: {
                    id: params.id
                }
            });
            ...
            if (!row) {
                throw errors.types.invalidParams({
                    path: 'id', message: 'Prestation with the specified id cannot be found',
                });
            }
    ...
    remove: function(params, callback, sid, req) {
        session.verify(req).then(function(session) {
            ...
            return models.Prestation.findOne({
                where: {
                    id: params.id
                }
            });
    ...
    filters: function(params, callback, sid, req) {
        session.verify(req).then(function() {
            return helpers.fetchFilters(params, models.Prestation);
