...
var Service = {
    list: function(params, callback, sid, req) {
        session.verify(req).then(function(session) {
            ...
            return models.Beneficiaire.scope('nested').findAndCount(
                helpers.sequelizify(params, models.Beneficiaire));
    ...
    insert: function(params, callback, sid, req) {
        session.verify(req).then(function(session) {
            ...
            return models.Beneficiaire.create(params);
        }).then(function(row) {
    ...
    update: function(params, callback, sid, req) {
        session.verify(req).then(function(session) {
            ...
            return models.Beneficiaire.scope('nested').findOne({
                where: {
                    id: params.id
                }
            });
            ...
            if (!row) {
                throw errors.types.invalidParams({
                    path: 'id', message: 'Beneficiaire with the specified id cannot be found',
                });
            }
    ...
    remove: function(params, callback, sid, req) {
        session.verify(req).then(function(session) {
            ...
            return models.Beneficiaire.findOne({
                where: {
                    id: params.id
                }
            });
    ...
    filters: function(params, callback, sid, req) {
        session.verify(req).then(function() {
            return helpers.fetchFilters(params, models.Beneficiaire);
